...
-- ----------------------------
 ...
 ('1', '山东农信', null, '2018-01-22 19:00:38', '2018-01-22 19:00:38', '0', '0');
  INSERT INTO `sys_dept` VALUES 
  ('2', '沙县国际', null, '2018-01-22 19:00:38', '2018-01-23 12:42:04', '0', '0');
   INSERT INTO `sys_dept` VALUES 
...
CREATE TABLE `sys_role_dept` (
  ...
  PRIMARY KEY (`id`)
) DEFAULT CHARSET=utf8 COMMENT='角色与部门对应关系';
...
CREATE TABLE `sys_zuul_route` (
  ...
  `del_flag` char(1) DEFAULT '0' COMMENT '删除标识（0-正常,1-删除）',
  PRIMARY KEY (`id`)
)DEFAULT CHARSET=utf8  COMMENT='动态路由配置表';
...
CREATE TABLE `zipkin_annotations` (
  ...
  `a_datetime` bigint(20) DEFAULT NULL COMMENT 'Used to implement TTL; Annotation.datetime or zipkin_spans.datetime',
...
CREATE TABLE `zipkin_spans` (
  ...
  `start_ts` bigint(20) DEFAULT NULL COMMENT 'Span.datetime(): epoch micros used for endTs query and to implement TTL',
